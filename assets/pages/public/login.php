...
<body>
      ...
      <section class="form-section" id="login-form-section">
        ...
        <form id="login-form" action="../../php/signin.php" method="POST" novalidate>
          ...
          <div class="field-group" id="group-email">
            <label for="email">Email or Mobile Number <span aria-label="required">*</span></label>
            <input
                  type="text"
                  id="email"
                  name="email"
                  required
                  autocomplete="email"
                  placeholder="example@email.com or 09171234567"
  ...
  <?php if(isset($_GET['error'])): ?>
    ...
    <script>
      ...
      <?php elseif($_GET['error'] === 'wrong-role'): ?>
