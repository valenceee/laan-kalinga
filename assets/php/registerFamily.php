...
$relationship          = $_POST['relationship']             ?? 'family_representative';
$isDecisionMaker       = isset($_POST['decision_maker']) && $_POST['decision_maker'] === 'yes' ? 1 : 1;
$preferredContactMethod = $_POST['preferred_contact_method'] ?? 'phone';
$updateFrequency       = $_POST['update_frequency']         ?? 'as_needed';
